  ...
  return (
    <div className="animate-in fade-in duration-500">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        {blocks.map(block => (
          <Link key={block.id} href={`/app/blocks/${block.id}`}>
            <a className="bg-[#111113] border border-white/10 p-6 rounded-lg hover:border-primary/50 transition-colors group block">
