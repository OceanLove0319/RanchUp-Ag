...
export default function GuildLanding() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "No. RanchUp™ is independent. You use whatever suppliers and PCAs you currently use."
    },
    {
    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary selection:text-primary-foreground">
      ...
      <section className="pt-32 md:pt-40 pb-16 md:pb-20 px-4 md:px-6 max-w-6xl mx-auto min-h-[85vh] flex flex-col justify-center">
        ...
        <p className="text-lg md:text-2xl text-muted-foreground font-medium max-w-3xl mb-10 md:mb-12 leading-relaxed">
          A limited circle of Central Valley operators piloting RanchUp™ in-season—then getting paid for the adoption they help originate.
        </p>
          ...
          <div className="bg-white/5 border border-border rounded-2xl p-6 md:p-10">
            ...
            <ul className="space-y-4 md:space-y-6">
              <li className="flex gap-3 md:gap-4">
                ...
                <p className="text-muted-foreground font-medium text-base md:text-lg leading-snug">A small group piloting RanchUp™ during the season</p>
              </li>
              <li className="flex gap-3 md:gap-4">
                <div className="w-1.5 h-1.5 rounded-full bg-green-500 mt-2"></div>
      ...
      <footer className="py-12 px-6 border-t border-border text-center">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="font-black tracking-tighter text-lg uppercase text-foreground/50">RanchUp™</span>
          </div>
          ...
          <div className="flex justify-center gap-6 text-xs font-bold uppercase tracking-widest text-muted-foreground">
            ...
            <a href="mailto:hello@ranchup.com" className="hover:text-foreground transition-colors">Contact</a>
          </div>
          <div className="mt-8">
              ...
              <div className="bg-white p-4 md:p-8 rounded shadow-sm min-h-[500px] text-white">
                <div className="border-b-2 border-black pb-4 mb-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                  ...
                  <div className="text-left md:text-right">
                    ...
                    <p className="text-xs md:text-sm text-muted-foreground">Generated by RanchUp</p>
                  </div>
                </div>
